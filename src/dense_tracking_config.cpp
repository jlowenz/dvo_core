...
std::ostream& operator<< (std::ostream& out, const dvo::DenseTracker::Config& config)
{
  out
...
std::ostream& operator <<(std::ostream& out, const dvo::DenseTracker::IterationContext& ctx)
{
  out
  << "Level: " << ctx.Level
